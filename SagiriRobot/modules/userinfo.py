...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        text += "\n\nᴛʜᴇ ᴜꜱᴇʀ  ᴜsᴇʀ ɪs ʟᴇᴀᴅᴇʀ ᴏꜰ <b>ɢᴏᴊᴏ ᴄʟᴀɴ</b>.\n"
    elif user.id in DEV_USERS:
        text += "\n\nᴛʜɪs ᴜsᴇʀ ɪs ᴛʜᴇ ᴄʀᴇᴀᴛᴏʀ ᴏғ <b>ɢᴏᴊᴏ ᴄʟᴀɴ</b>.\n"
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/gojo_satoru_updates/10"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/gojo_satoru_updates/11"
                            ),
                        ],
                    ]
                ),
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>➯ ᴄᴜʀʀᴇɴᴛ sᴛᴀᴛs ᴏꜰ ɢᴏᴊᴏ ꜱᴀᴛᴏʀᴜ:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
