...
from SagiriRobot import OWNER_ID, pbot
from SagiriRobot.utils.admins import can_change_info
from SagiriRobot.utils.errors import capture_err
from SagiriRobot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote = r"^((?i)\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤|💘|cool|good|👍|baby|thnx|thank you|gud|thankyou|love|pro)$"
