...
import SagiriRobot.modules.sql.users_sql as sql
...
from SagiriRobot.modules.helper_funcs.extraction import extract_user_and_text
from SagiriRobot.modules.helper_funcs.string_handling import extract_time
from SagiriRobot.modules.log_channel import gloggable, loggable

UNBAN_IMG= "https://te.legra.ph/file/0b6ddb1b0425a2247b145.mp4"
BAN_IMG= "https://te.legra.ph/file/b51d5db07c7bf372a9c15.mp4"
KICK_IMG= "https://te.legra.ph/file/880e6f8b0d2c0bb428bad.mp4"
SELF_KICK_IMG= "https://te.legra.ph/file/addd84ba85d3c39120e13.mp4"
    ...
    try:
        ...
        bot.send_animation(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
       InlineKeyboardButton(text="ᴜɴʙᴀɴ", callback_data=f"unbanb_unban={user_id}"),
