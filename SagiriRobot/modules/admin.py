...
from SagiriRobot import DRAGONS, dispatcher
from SagiriRobot.modules.disable import DisableAbleCommandHandler
from SagiriRobot.modules.helper_funcs.admin_rights import user_can_changeinfo
...
def adminlist(update, context):
    ...
    try:
        msg = update.effective_message.reply_text(
            "𝙵𝙴𝚃𝙲𝙷𝙸𝙽𝙶 𝙶𝚁𝙾𝚄𝙿 𝙰𝙳𝙼𝙸𝙽𝚂...", parse_mode=ParseMode.HTML
        )
    except BadRequest:
        msg = update.effective_message.reply_text(
            "𝙵𝙴𝚃𝙲𝙷𝙸𝙽𝙶 𝙶𝚁𝙾𝚄𝙿 𝙰𝙳𝙼𝙸𝙽𝚂...", quote=False, parse_mode=ParseMode.HTML
        )
