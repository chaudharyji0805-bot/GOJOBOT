...
import SagiriRobot.modules.sql.logger_sql as sql
from SagiriRobot.modules.helper_funcs.anonymous import AdminPerms
from SagiriRobot.modules.helper_funcs.anonymous import user_admin as u_admin
from SagiriRobot.modules.helper_funcs.decorators import Sagiricmd
from SagiriRobot.modules.log_channel import loggable


@Sagiricmd(command="announce", pass_args=True)
