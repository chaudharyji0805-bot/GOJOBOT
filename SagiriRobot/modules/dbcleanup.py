...
import SagiriRobot.modules.sql.global_bans_sql as gban_sql
import SagiriRobot.modules.sql.users_sql as user_sql
from SagiriRobot import DEV_USERS, OWNER_ID, dispatcher
