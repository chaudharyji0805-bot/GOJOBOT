...
import SagiriRobot
import SagiriRobot.modules.sql.welcome_sql as sql
...
from SagiriRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from SagiriRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from SagiriRobot.modules.helper_funcs.msg_types import get_welcome_type
from SagiriRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from SagiriRobot.modules.log_channel import loggable
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "wew, sir Jashan just joined thee chat.", reply_to_message_id=reply
                )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "wow supreme user just joined the chat",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome yourself
                ...
                if not SagiriRobot.ALLOW_CHATS:
                ...
                "ᴋᴏɴɪᴄʜɪᴡᴀ ɢᴜʏꜱ ᴛʜɪꜱ ɪꜱ ɢᴏᴊᴏ ꜱᴀᴛᴏʀᴜ ᴛʜᴇᴇ ᴀᴅᴠᴀɴᴄᴇ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ᴡɪᴛʜ ᴇɴʜᴀɴᴄᴇ ꜰᴇᴀᴛᴜʀᴇꜱ\n⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯\nɪꜰ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴍɪꜱᴜɴᴅᴇʀꜱᴛᴀɴᴅɪɴɢ ᴀɴᴅ ᴅᴏɴ'ᴛ ᴋɴᴏᴡ ʜᴏᴡ ᴛᴏ ᴜꜱᴇ ᴍᴇ ᴛʜᴇɴ ᴄʜᴇᴄᴋ ᴍʏ ꜰᴇᴀᴛᴜʀᴇꜱ ɪɴ ᴘᴍ ᴀɴᴅ ᴛᴀᴋᴇ ᴀ ᴠɪᴇᴡ ᴏꜰ ᴍʏ ᴄᴏᴍᴍᴀɴᴅꜱ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ", reply_to_message_id=reply,
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                text="ᴄʜᴇᴄᴋ ᴄᴏᴍᴍᴀɴᴅꜱ ɪɴ ᴘᴍ",
                                url=f"https://t.me/Gojo_proxbot?start=help",
                            ),
                        ]
                    ]
                ),
