...
DRAGONS.add(6432025901)
DRAGONS.add(6058139652)
DRAGONS.add(6864672519)
DRAGONS.add(6944225218)
DRAGONS.add(6438969887)
DRAGONS.add(OWNER_ID)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(6171176459)
DEV_USERS.add(6058139652)
...
try:
    ...
    LOGGER.info("[Sagiri]: Connecting to redis")
except BaseException:

    raise Exception("[Sagiri ERROR]: Redis Database Is Not Alive, Please Check Again.")

finally:

   REDIS.ping()

   LOGGER.info("[Sagiri]: Connection to Redis Database Established Successfully!")
